# ============================================================================
# Questa Automation Script for AES-128
# ============================================================================
...
#
# Usage in Questa GUI:    do run_questa.do
# Usage in command line:  vsim -c -do run_questa.do
# ============================================================================
...
write format wave -window .main_pane.wave.interior.cs.body.pw.wf aes_questa.do
